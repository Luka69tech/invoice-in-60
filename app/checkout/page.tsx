...
function CoinIcon({ icon, color, size = 32 }: { icon: string; color: string; size?: number }) {
  ...
  const svgMap: Record<string, string> = {
    ...
    bnb: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#F3BA2F"/><path d="M32 12L20 32l12 8-12 8 12 20 12-20-12-8 12-8z" fill="#FFF"/></svg>`,
    matic: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#8247E5"/><path d="M32 16l10 6v12l-10 6-10-6V22l10-6z" fill="#FFF"/><path d="M32 22v12l-10-6" fill="#FFF" fillOpacity="0.5"/><path d="M32 34v12l10-6" fill="#FFF" fillOpacity="0.5"/><path d="M22 34l10 6 10-6" fill="#FFF"/></svg>`,
    avax: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#E84142"/><path d="M32 12L20 32l12 8-12 8 12 20 12-20-12-8 12-8z" fill="#FFF"/></svg>`,
    ...
    ada: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#0033AD"/><circle cx="32" cy="20" r="6" fill="#FFF"/><path d="M32 20v24l16-12z" fill="#FFF" fillOpacity="0.5"/><path d="M32 44v-24l-16 12z" fill="#FFF"/></svg>`,
    ...
    ton: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#0098EA"/><path d="M20 44V20h8l16 16 16-16h-8V44h-8V28l-16-16-16 16v16h-8z" fill="#FFF"/></svg>`,
    xrp: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#23292F"/><path d="M32 8C18.745 8 8 18.745 8 32s10.745 24 24 24 24-10.745 24-24S45.255 8 32 8zm10.5 35.5c0 2.485-4.5 4.5-10.5 4.5s-10.5-2.015-10.5-4.5v-7c0-2.485 4.5-4.5 10.5-4.5s10.5 2.015 10.5 4.5v7zm0-17c0 2.485-4.5 4.5-10.5 4.5s-10.5-2.015-10.5-4.5v-7c0-2.485 4.5-4.5 10.5-4.5s10.5 2.015 10.5 4.5v7z" fill="#FFF"/></svg>`,
    algo: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#FBCC5C"/><path d="M32 12L52 44H12L32 12Z" fill="#FFF"/><path d="M32 52L12 20H52L32 52Z" fill="#FFF" fillOpacity="0.5"/></svg>`,
    stellar: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#14B6E7"/><path d="M44 20l-8 12 8 12M20 44l8-12-8-12M32 14c-2 4-6 6-10 6 4 0 8 2 10 6M32 50c2-4 6-6 10-6-4 0-8-2-10-6" stroke="#FFF" strokeWidth="3" strokeLinecap="round"/></svg>`,
    polygon: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#8247E5"/><path d="M44 24l-8 4v8l8 4M20 24l8 4v8l-8 4M32 32l8-4M32 32l-8-4M32 32v8M32 40l-8-4M32 40l8-4" stroke="#FFF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>`,
    arbitrum: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#28A0F0"/><path d="M32 16l16 8-16 24-16-24 16-8z" fill="#FFF" fillOpacity="0.9"/><path d="M32 32l8 4-8 12-8-12 8-4z" fill="#FFF"/></svg>`,
    optimism: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#FF0420"/><circle cx="32" cy="32" r="12" fill="#FFF"/></svg>`,
    base: `<svg width="${size}" height="${size}" viewBox="0 0 64 64" fill="none"><rect width="64" height="64" rx="16" fill="#0052FF"/><path d="M40 24H24l8 8-8 8h16l8-8-8-8z" fill="#FFF"/><circle cx="24" cy="24" r="3" fill="#FFF"/><circle cx="40" cy="24" r="3" fill="#FFF"/><circle cx="24" cy="40" r="3" fill="#FFF"/><circle cx="40" cy="40" r="3" fill="#FFF"/></svg>`,
