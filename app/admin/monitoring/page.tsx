        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 bg-[#171717] border border-[#262626] rounded-xl text-white placeholder-[#555] focus:outline-none focus:border-[#3d3d3d] transition-colors"
            />
